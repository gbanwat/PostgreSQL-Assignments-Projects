...
--------------------------------------------------------------------------------
SELECT sub_category, AVG(unit_price) AS avg_unit_price, AVG(unit_cost) AS avg_unit_cost, 
...
--------------------------------------------------------------------------------
SELECT customer_age,sub_category,AVG(quantity ::NUMERIC) AS average_quantity,
...
--------------------------------------------------------------------------------
SELECT sub_category, ROUND(AVG(quantity::NUMERIC(10,4)),2) AS avg_quantity,
